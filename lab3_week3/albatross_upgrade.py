...
def framed_ellipse(x1, y1, x2, y2, a, color_name_1, thickness, color_name_2):
    penSize(thickness)
    for i in range( ceil( (x1+x2)*0.5 - a*0.5  ), ceil( (x1+x2)*0.5 + a*0.5 ) ):
        for j in range( ceil( (y1+y2)*0.5 - a*0.5 ), ceil( (y1+y2)*0.5 + a*0.5 ) ):
            if ( (distance(x1, y1, i, j) + distance(x2, y2, i, j)) <= a ):
                point(i, j, color_name_1)
            elif (abs((distance(x1, y1, i, j) + distance(x2, y2, i, j)) - a) <= thickness):
...
rectangle(0, 0, width, 90)
brushColor(123, 104, 238)
rectangle(0, 0+90, width, 90+40)
brushColor(221, 160, 221)
rectangle(0, 0+90+40, width, 90+40+70)
brushColor(238, 130, 238)
rectangle(0, 0+90+40+70, width, 90+40+70+100)
brushColor(255, 160, 122)
rectangle(0, 0+90+40+70+100, width, 90+40+70+100+50)
brushColor(70, 130, 180)
rectangle(0, 0+90+40+70+100+50, width, 90+40+70+100+50+250)

albatros_suka(40, 350, 5)
albatros_suka(150, 200, 2)
albatros_suka(500, 300, 4)
